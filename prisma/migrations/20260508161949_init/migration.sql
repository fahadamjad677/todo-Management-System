...
-- CreateIndex
CREATE UNIQUE INDEX "Task_reportedToId_key" ON "Task"("reportedToId");
...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_reportedToId_fkey" FOREIGN KEY ("reportedToId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
